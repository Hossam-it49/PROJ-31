...
$docname="SELECT doctors_account.NameAr FROM doctors_account ,doctorscourse  WHERE doctors_account.DoctorCode=doctorscourse.DoctorCode AND doctorscourse.CourseCode=$code";
$docname1=mysqli_query($bis, $docname) or die(mysqli_error($bis));
$quer=mysqli_fetch_array($docname1);
...
$totalRows_legan_doctors = mysqli_num_rows($legan_doctors);
        ...
        <tr align="center" valign="middle" <?php if($totalRows_legan_doctors >1 ) { ?>  bgcolor="#99FF99" <?php } ?>>
          ...
          <th width="12%" height="30" align="center" valign="middle" scope="row"><a href="assign_observers.php?lagna=<?php echo $row_leganList['lagna_no']; ?>"><span class="style23"> تسكسين المراقبين </span></a></th>
          <th width="12%" height="30" align="center" valign="middle" scope="row"><a href="lagna_students_names_final.php?SchID=<?php echo $code;?>&amp;lagna=<?php echo $row_leganList['lagna_no']; ?>"><span class="style23">عرض الفاينال</span></a></th>
            ...
            <th width="29%" align="center" valign="middle" scope="row"><?php do {  foreach($docname1 as $dehk) { ?>
              <table width="90%" border="0">
                ...
                <tr>
                  <td align="center">د. <?php  echo $dehk['NameAr'];  ?> </td>
                </tr>
                                </table>
