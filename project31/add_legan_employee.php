...
$del= "delete from legan_employees where empID='$emp' AND SchID='$scID' AND lagna_no='$lagnaID' ";
if(!mysqli_query($bis,$del)){die('Error:'. mysqli_error($bis));}
else {
echo ' 
       <script type="text/javascript"> 
        window.location = "index.php?page=addLagnaEmp" 
...
<td align="center" valign="middle" bgcolor="#CCCCCC"><label> اسم الملاحظ</label> 
<br>
</td></tr>
...
<tr><td colspan="6" align="center" bgcolor="yellow"> الملاحظين الذين تم تسكينهم في اللجنة</td></tr>
<tr>
<th bgcolor="#CCCCCC"> حذف</th>
<th bgcolor="#CCCCCC">اسم الملاحظ</th>
<th bgcolor="#CCCCCC"> م</th>
</tr>
<?php 
$x=1;
$sSQL= 'SET CHARACTER SET utf8'; 
...
<form action="add_legan_employee.php" method ="POST" name="delete">
  <input type="hidden" id="course" name="course" value="<?php echo $code;?>">
  <input type="hidden" id="lagna" name="lagna" value="<?php echo $lagna;?>"> 
    <input type="hidden" id="emp" name="emp" value="<?php echo $row_legan_employees['empID'];?>"> 
...
<?php $x++;} while($row_legan_employees = mysqli_fetch_assoc($legan_employees)); ?>
</table>
<script type="text/javascript">
<!--
